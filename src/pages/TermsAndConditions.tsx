...
return (
  <div className="bg-white min-h-screen flex flex-col md:h-screen">
    ...
    {/* Main Content */}
    <div className="flex-1 px-4 py-1 overflow-y-auto md:px-0 md:py-0 md:overflow-y-auto md:pb-16 md:pt-14">
      <div className="w-full max-w-2xl mx-auto md:max-h-[calc(100vh)] md:overflow-y-auto">
        ...
        <div className="space-y-3 md:space-y-4 text-center text-sm md:text-md">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-snug">
              You certify that all parts of the{" "}
              <a
                href="https://www.cntraveller.in/info/tra-2025-panelist-declaration-form/"
              ...
              and voting form are true and correct. By participating in the awards,
