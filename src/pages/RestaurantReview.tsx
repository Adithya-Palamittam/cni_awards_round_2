...
const RestaurantReview = () => {
  ...
  const combinedRestaurants = [...nationalRestaurants];
  ...
  const updateSelectionInSupabase = async (updatedNational: Restaurant[]) => {
  ...
  const removeRestaurant = (restaurantId: string) => {
    ...
    updateSelectionInSupabase(updatedNational);
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="px-4 md:pt-4">
        <div className="flex justify-between items-center">
          <h2 className="md:text-2xl text-md md:pr-10 py-2 flex-1 text-center">
            These are your top 15 restaurants
          </h2>
          <HamburgerMenu />
        </div>
